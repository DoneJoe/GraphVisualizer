...
/**
 * A restricted graph gives restricted access to the vertices and edges.
 * This graph operates with restricted graph items. A restricted graph item
 * restricts the operations on the item to a subset of all possible operations
 * (see specification of IRestrictedGraphItem).
 * Adding and removing graph elements is not possible. 
 * 
